...
function getInvoices()
{
	...
	$mysqli = new mysqli(DATABASE_HOST, DATABASE_USER, DATABASE_PASS, DATABASE_NAME, PORT_NO);
...
function getpaidList()
{
	...
	if ($results) {
		...
		while ($row = $results->fetch_assoc()) {
			$total_months = $row["invoice_due_date"] - $row["invoice_date"];
			$total_months +=1;
			$total_amount = $total_months * $row['subtotal'];
			print '
				<tr>
					<td>' . $row["invoice"] . '</td>
					<td>' . $row["name"] . '</td>
				    ...
				    <td>';
			if ($row["invoice_date"] == 1) {
				echo "January";
			}
			if ($row["invoice_date"] == 2) {
				echo "February";
			}
			if ($row["invoice_date"] == 3) {
				echo "March";
			}
			if ($row["invoice_date"] == 4) {
				echo "April";
			}
			if ($row["invoice_date"] == 5) {
				echo "May";
			}
			if ($row["invoice_date"] == 6) {
				echo "June";
			}
			if ($row["invoice_date"] == 7) {
				echo "July";
			}
			if ($row["invoice_date"] == 8) {
				echo "August";
			}
			if ($row["invoice_date"] == 9) {
				echo "September";
			}
			if ($row["invoice_date"] == 10) {
				echo "Octomber";
			}
			if ($row["invoice_date"] == 11) {
				echo "November";
			}
			if ($row["invoice_date"] == 12) {
				echo "December";
			}
			// .$row["invoice_date"].
			...
			if ($row["invoice_due_date"] == 1) {
				echo "January";
			}
			if ($row["invoice_due_date"] == 2) {
				echo "February";
			}
			if ($row["invoice_due_date"] == 3) {
				echo "March";
			}
			if ($row["invoice_due_date"] == 4) {
				echo "April";
			}
			if ($row["invoice_due_date"] == 5) {
				echo "May";
			}
			if ($row["invoice_due_date"] == 6) {
				echo "June";
			}
			if ($row["invoice_due_date"] == 7) {
				echo "July";
			}
			if ($row["invoice_due_date"] == 8) {
				echo "August";
			}
			if ($row["invoice_due_date"] == 9) {
				echo "September";
			}
			if ($row["invoice_due_date"] == 10) {
				echo "Octomber";
			}
			if ($row["invoice_due_date"] == 11) {
				echo "November";
			}
			if ($row["invoice_due_date"] == 12) {
				echo "December";
			}

			print '<td style="font-weight: bold";>' . $total_amount . '</td>';
